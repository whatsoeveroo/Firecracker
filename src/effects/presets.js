  ...
  rays: [
    {
      ...
      name: 'Divine Light',
      params: { sourceX: 6, sourceY: 0, direction: 34, spreadAngle: 42, beamLength: 112, beamWidth: 62, sourceGlow: 96, rayCount: 10, intensity: 92, softness: 76, density: 86, falloff: 84, atmosphericHaze: 88, edgeFeather: 90, noiseAmount: 68, noiseScale: 44, occlusionGaps: 48, dustAmount: 62, particleSize: 40, particleBrightness: 50, driftSpeed: 24, atmosphereMode: 'dusty', rayColor: '#ffd27a', hazeColor: '#8a5c24', glowColor: '#fff7dc', colorBlend: 58, streakSoftness: 48, motionAmount: 48, flickerAmount: 4, drift: 34, breathing: 28, animationSpeed: 48, turbulenceSpeed: 18 },
    },
    {
      // Off-axis directional shaft entering a dark room — readable shaft breakup, heavy visible dust
      name: 'Window Sunbeam',
      params: { sourceX: 92, sourceY: 6, direction: 150, spreadAngle: 24, beamLength: 104, beamWidth: 42, sourceGlow: 82, rayCount: 9, intensity: 90, softness: 66, density: 88, falloff: 66, atmosphericHaze: 80, edgeFeather: 78, noiseAmount: 82, noiseScale: 62, occlusionGaps: 86, dustAmount: 96, particleSize: 40, particleBrightness: 50, driftSpeed: 38, atmosphereMode: 'dusty', rayColor: '#ffb840', hazeColor: '#a06820', glowColor: '#fff0c8', colorBlend: 60, streakSoftness: 30, motionAmount: 54, flickerAmount: 7, drift: 46, breathing: 12, animationSpeed: 62, turbulenceSpeed: 22 },
    },
    {
      // Leaf-filtered forest light: high irregularity, clustered patchy gaps, organic green-gold tint
      name: 'Forest Morning',
      params: { sourceX: 66, sourceY: 0, direction: 108, spreadAngle: 86, beamLength: 106, beamWidth: 78, sourceGlow: 60, rayCount: 20, intensity: 72, softness: 88, density: 88, falloff: 70, atmosphericHaze: 86, edgeFeather: 94, noiseAmount: 98, noiseScale: 70, occlusionGaps: 98, dustAmount: 56, particleSize: 40, particleBrightness: 50, driftSpeed: 32, atmosphereMode: 'misty', rayColor: '#c8e060', hazeColor: '#60a030', glowColor: '#eeffc0', colorBlend: 78, streakSoftness: 58, motionAmount: 50, flickerAmount: 6, drift: 44, breathing: 26, animationSpeed: 56, turbulenceSpeed: 24 },
    },
    {
      // Theatrical beam from high corner — tight clustered shafts, smoke-revealed volume, high flicker
      name: 'Stage Spotlight',
      params: { sourceX: 14, sourceY: 2, direction: 56, spreadAngle: 18, beamLength: 116, beamWidth: 30, sourceGlow: 88, rayCount: 6, intensity: 94, softness: 62, density: 80, falloff: 60, atmosphericHaze: 88, edgeFeather: 70, noiseAmount: 62, noiseScale: 38, occlusionGaps: 42, dustAmount: 72, particleSize: 40, particleBrightness: 50, driftSpeed: 34, atmosphereMode: 'smoky', rayColor: '#c8e0ff', hazeColor: '#7090b0', glowColor: '#ffffff', colorBlend: 36, streakSoftness: 22, motionAmount: 46, flickerAmount: 18, drift: 28, breathing: 18, animationSpeed: 68, turbulenceSpeed: 32 },
    },
    {
      // Dense suspended medium, slow wide undulation, heavy particulate, deep cyan volume
      name: 'Underwater Shaft',
      params: { sourceX: 72, sourceY: 0, direction: 118, spreadAngle: 64, beamLength: 118, beamWidth: 82, sourceGlow: 52, rayCount: 10, intensity: 78, softness: 72, density: 92, falloff: 38, atmosphericHaze: 88, edgeFeather: 88, noiseAmount: 68, noiseScale: 78, occlusionGaps: 42, dustAmount: 88, particleSize: 40, particleBrightness: 50, driftSpeed: 72, atmosphereMode: 'underwater', rayColor: '#38c8f8', hazeColor: '#0668a8', glowColor: '#c8f4ff', colorBlend: 78, streakSoftness: 58, motionAmount: 82, flickerAmount: 2, drift: 72, breathing: 52, animationSpeed: 70, turbulenceSpeed: 52 },
    },
    {
      // Thick dirty air, shafts barely legible through haze, subdued palette, moodier atmosphere
      name: 'Smoky Room',
      params: { sourceX: 88, sourceY: 20, direction: 157, spreadAngle: 50, beamLength: 92, beamWidth: 96, sourceGlow: 44, rayCount: 12, intensity: 50, softness: 98, density: 98, falloff: 76, atmosphericHaze: 98, edgeFeather: 98, noiseAmount: 94, noiseScale: 42, occlusionGaps: 74, dustAmount: 94, particleSize: 40, particleBrightness: 50, driftSpeed: 26, atmosphereMode: 'smoky', rayColor: '#c8b890', hazeColor: '#706048', glowColor: '#ffe8b0', colorBlend: 82, streakSoftness: 74, motionAmount: 42, flickerAmount: 3, drift: 34, breathing: 16, animationSpeed: 48, turbulenceSpeed: 18 },
    },
    {
      // Grand majestic spread: large-scale dark cloud gaps, broad shaft families, celestial scale
      name: 'Cloud Break',
      params: { sourceX: 54, sourceY: 0, direction: 92, spreadAngle: 84, beamLength: 118, beamWidth: 88, sourceGlow: 98, rayCount: 18, intensity: 86, softness: 94, density: 80, falloff: 92, atmosphericHaze: 92, edgeFeather: 98, noiseAmount: 90, noiseScale: 28, occlusionGaps: 90, dustAmount: 28, particleSize: 40, particleBrightness: 50, driftSpeed: 22, atmosphereMode: 'misty', rayColor: '#ffe8b8', hazeColor: '#c09848', glowColor: '#ffffff', colorBlend: 60, streakSoftness: 50, motionAmount: 34, flickerAmount: 4, drift: 28, breathing: 34, animationSpeed: 40, turbulenceSpeed: 16 },
    },
    {
      // Cold narrow beam with gritty fog — tight shaft cluster, strong occlusion breakup, high flicker
      name: 'Horror Flashlight',
      params: { sourceX: 2, sourceY: 56, direction: 346, spreadAngle: 15, beamLength: 98, beamWidth: 24, sourceGlow: 32, rayCount: 5, intensity: 82, softness: 48, density: 76, falloff: 54, atmosphericHaze: 78, edgeFeather: 54, noiseAmount: 98, noiseScale: 80, occlusionGaps: 92, dustAmount: 86, particleSize: 40, particleBrightness: 50, driftSpeed: 28, atmosphereMode: 'foggy', rayColor: '#a8b8cc', hazeColor: '#4c6070', glowColor: '#c0d0e0', colorBlend: 42, streakSoftness: 28, motionAmount: 50, flickerAmount: 34, drift: 18, breathing: 5, animationSpeed: 70, turbulenceSpeed: 44 },
    },
  ],
