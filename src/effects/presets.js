  ...
  glare: [
    {
      ...
      params: {
        ...
        haloAmount: 42, haloShape: 'round', burstAmount: 28, burstSize: 44, burstDensity: 48, burstShape: 'softStar', burstSoftness: 62, burstSharpness: 34,
        starburstAmount: 14, starburstShape: 'softDiffraction', patternComplexity: 46,
        sourceX: 50, sourceY: 50, sourceColor: '#ffe6aa', coatingColor: '#8fd8ff',
    ...
    },
    {
      ...
      params: {
        ...
        haloAmount: 34, haloShape: 'doubleHalo', burstAmount: 54, burstSize: 46, burstDensity: 56, burstShape: 'sixPoint', burstSoftness: 38, burstSharpness: 68,
        starburstAmount: 24, starburstShape: 'sixPoint', patternComplexity: 42,
        sourceX: 50, sourceY: 50, sourceColor: '#fff0b8', coatingColor: '#92d4ff',
    ...
    },
    {
      ...
      params: {
        ...
        haloAmount: 78, haloShape: 'round', burstAmount: 8, burstSize: 34, burstDensity: 22, burstShape: 'diffractionBloom', burstSoftness: 88, burstSharpness: 16,
        starburstAmount: 0, starburstShape: 'none', patternComplexity: 18,
        sourceX: 50, sourceY: 50, sourceColor: '#ffe7be', coatingColor: '#b8ddff',
    ...
    },
    {
      ...
      params: {
        ...
        haloAmount: 64, haloShape: 'apertureRing', burstAmount: 78, burstSize: 56, burstDensity: 68, burstShape: 'eightPoint', burstSoftness: 34, burstSharpness: 72,
        starburstAmount: 42, starburstShape: 'eightPoint', patternComplexity: 68,
        sourceX: 50, sourceY: 50, sourceColor: '#fff2c6', coatingColor: '#a5e2ff',
        frameFitMode: 'safe', globalScale: 72, safeMargin: 18,
    ...
    },
    {
      ...
      params: {
        ...
        haloAmount: 42, haloShape: 'ellipse', burstAmount: 74, burstSize: 62, burstDensity: 44, burstShape: 'anamorphicCross', burstSoftness: 42, burstSharpness: 52,
        starburstAmount: 46, starburstShape: 'anamorphicCross', patternComplexity: 56,
        sourceX: 50, sourceY: 50, sourceColor: '#bcefff', coatingColor: '#55baff',
        frameFitMode: 'safe', globalScale: 72, safeMargin: 18,
    ...
    },
    {
      ...
      params: {
        ...
        intensity: 78, size: 70, softness: 86, colorMode: 'sunset', warmth: 78, saturation: 62, colorSpread: 48, fringeAmount: 28,
        haloAmount: 76, haloShape: 'corona', burstAmount: 36, burstSize: 66, burstDensity: 72, burstShape: 'flowerBurst', burstSoftness: 78, burstSharpness: 24,
        starburstAmount: 18, starburstShape: 'softDiffraction', patternComplexity: 78,
        sourceX: 50, sourceY: 50, sourceColor: '#ffd28a', coatingColor: '#8df2cf',
    ...
    },
    {
      ...
      params: {
        ...
        haloAmount: 54, haloShape: 'doubleHalo', burstAmount: 58, burstSize: 48, burstDensity: 62, burstShape: 'diffractionBloom', burstSoftness: 44, burstSharpness: 48,
        starburstAmount: 28, starburstShape: 'softDiffraction', patternComplexity: 66,
        sourceX: 50, sourceY: 50, sourceColor: '#88f6ff', coatingColor: '#5f8cff',
    ...
    },
    {
      ...
      params: {
        ...
        intensity: 72, size: 64, softness: 84, colorMode: 'sunset', warmth: 92, saturation: 48, colorSpread: 20, fringeAmount: 10,
        haloAmount: 62, haloShape: 'apertureRing', burstAmount: 18, burstSize: 42, burstDensity: 28, burstShape: 'softStar', burstSoftness: 78, burstSharpness: 22,
        starburstAmount: 8, starburstShape: 'fourPoint', patternComplexity: 34,
        sourceX: 50, sourceY: 50, sourceColor: '#ffbd6d', coatingColor: '#ffd09a',
    ...
    },
    {
      ...
      params: {
        ...
        haloAmount: 28, haloShape: 'apertureRing', burstAmount: 92, burstSize: 72, burstDensity: 54, burstShape: 'needleStar', burstSoftness: 18, burstSharpness: 92,
        starburstAmount: 48, starburstShape: 'needleStar', patternComplexity: 72,
        sourceX: 50, sourceY: 50, sourceColor: '#fff6d0', coatingColor: '#abd4ff',
    ...
    },
    {
      ...
      params: {
        ...
        haloAmount: 42, haloShape: 'round', burstAmount: 32, burstSize: 46, burstDensity: 42, burstShape: 'sixPoint', burstSoftness: 48, burstSharpness: 48,
        starburstAmount: 16, starburstShape: 'sixPoint', patternComplexity: 42,
        sourceX: 50, sourceY: 50, sourceColor: '#ffe8b8', coatingColor: '#9cd9ff',
