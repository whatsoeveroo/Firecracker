  ...
  sparks: [
    {
      ...
      params: {
        sparkCount: 34, spreadAngle: 16, length: 138, brightness: 100, decay: 92,
        direction: -90, directionalBurst: 96, flashSize: 98, gravity: 18, airDrag: 18,
        chaos: 18, trailLength: 30, trailWidth: 22, fragmentWeight: 18, microAmount: 28,
        colorTemp: 62, deflection: 0, randomSeed: 1101,
      },
    },
    {
      name: 'Sci-fi Flash',
      params: {
        sparkCount: 62, spreadAngle: 82, length: 126, brightness: 96, decay: 68,
        direction: -90, directionalBurst: 86, flashSize: 78, gravity: 8, airDrag: 28,
        chaos: 36, trailLength: 58, trailWidth: 16, fragmentWeight: 10, microAmount: 52,
        colorTemp: 14, deflection: 0, randomSeed: 2402,
      },
    },
    {
      name: 'Welding Sparks',
      params: {
        sparkCount: 86, spreadAngle: 70, length: 74, brightness: 88, decay: 48,
        direction: -34, directionalBurst: 64, flashSize: 34, gravity: 90, airDrag: 56,
        chaos: 58, trailLength: 44, trailWidth: 32, fragmentWeight: 78, microAmount: 88,
        colorTemp: 74, deflection: 42, randomSeed: 3303,
      },
    },
    {
      name: 'Fireworks Burst',
      params: {
        sparkCount: 96, spreadAngle: 360, length: 118, brightness: 84, decay: 18,
        direction: -90, directionalBurst: 8, flashSize: 58, gravity: 58, airDrag: 18,
        chaos: 76, trailLength: 92, trailWidth: 46, fragmentWeight: 64, microAmount: 44,
        colorTemp: 56, deflection: 0, randomSeed: 4404,
      },
    },
  ],
