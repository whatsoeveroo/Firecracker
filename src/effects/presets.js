export const BUILT_IN_PRESETS = {
  ...
  rays: [
    ...
    },
    {
      ...
      name: 'Window Sunbeam',
      params: { sourceX: 92, sourceY: 6, direction: 150, spreadAngle: 24, beamLength: 104, beamWidth: 42, sourceGlow: 82, rayCount: 9, intensity: 90, softness: 66, density: 88, falloff: 66, atmosphericHaze: 80, edgeFeather: 78, noiseAmount: 82, noiseScale: 62, occlusionGaps: 86, dustAmount: 96, driftSpeed: 38, atmosphereMode: 'dusty', rayColor: '#ffb840', hazeColor: '#a06820', glowColor: '#fff0c8', colorBlend: 60, streakSoftness: 30, motionAmount: 54, flickerAmount: 7, drift: 46, breathing: 12, animationSpeed: 62, turbulenceSpeed: 22 },
    },
    {
    ...
    },
    {
      ...
      params: { sourceX: 14, sourceY: 2, direction: 56, spreadAngle: 18, beamLength: 116, beamWidth: 30, sourceGlow: 88, rayCount: 6, intensity: 94, softness: 62, density: 80, falloff: 60, atmosphericHaze: 88, edgeFeather: 70, noiseAmount: 62, noiseScale: 38, occlusionGaps: 42, dustAmount: 72, driftSpeed: 34, atmosphereMode: 'smoky', rayColor: '#c8e0ff', hazeColor: '#7090b0', glowColor: '#ffffff', colorBlend: 36, streakSoftness: 22, motionAmount: 46, flickerAmount: 18, drift: 28, breathing: 18, animationSpeed: 68, turbulenceSpeed: 32 },
    },
    {
      // Dense suspended medium, slow wide undulation, heavy particulate, deep cyan volume
      name: 'Underwater Shaft',
      params: { sourceX: 46, sourceY: 0, direction: 90, spreadAngle: 56, beamLength: 120, beamWidth: 92, sourceGlow: 48, rayCount: 15, intensity: 58, softness: 98, density: 98, falloff: 48, atmosphericHaze: 98, edgeFeather: 98, noiseAmount: 86, noiseScale: 84, occlusionGaps: 48, dustAmount: 94, driftSpeed: 70, atmosphereMode: 'underwater', rayColor: '#30c0f0', hazeColor: '#0870b8', glowColor: '#b0f0ff', colorBlend: 86, streakSoftness: 84, motionAmount: 88, flickerAmount: 2, drift: 74, breathing: 62, animationSpeed: 72, turbulenceSpeed: 58 },
    },
    {
      // Thick dirty air, shafts barely legible through haze, subdued palette, moodier atmosphere
      name: 'Smoky Room',
      params: { sourceX: 88, sourceY: 20, direction: 157, spreadAngle: 50, beamLength: 92, beamWidth: 96, sourceGlow: 44, rayCount: 12, intensity: 50, softness: 98, density: 98, falloff: 76, atmosphericHaze: 98, edgeFeather: 98, noiseAmount: 94, noiseScale: 42, occlusionGaps: 74, dustAmount: 94, driftSpeed: 26, atmosphereMode: 'smoky', rayColor: '#c8b890', hazeColor: '#706048', glowColor: '#ffe8b0', colorBlend: 82, streakSoftness: 74, motionAmount: 42, flickerAmount: 3, drift: 34, breathing: 16, animationSpeed: 48, turbulenceSpeed: 18 },
    },
    {
