...
export const EFFECTS = [
  {
    ...
    params: [
      ...
      { key: 'colorTemp',    label: 'Temperature',  min: 0,   max: 100, restartOnChange: false, hint: 'Cool → Warm' },
      ...
      { key: 'flameWidth',     label: 'Flame Width',     min: 10,   max: 220, restartOnChange: true,  advanced: true },
