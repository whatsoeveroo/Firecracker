...
export const EFFECTS = [
  {
    ...
    params: [
      ...
      { key: 'flameHeight',    label: 'Flame Height',      min: 20,   max: 180 },
      { key: 'flameWidth',     label: 'Flame Width',       min: 10,   max: 220 },
      { key: 'turbulence',     label: 'Turbulence',        min: 0,    max: 100 },
      { key: 'flickerSpeed',   label: 'Flicker Speed',     min: 10,   max: 100 },
      { key: 'windDir',        label: 'Wind Direction',    min: -180, max: 180, hint: '0 = vertical' },
      { key: 'windStrength',   label: 'Wind Strength',     min: 0,    max: 100 },
      { key: 'emberAmount',    label: 'Ember Amount',      min: 0,    max: 100 },
      { key: 'sparkAmount',    label: 'Spark Amount',      min: 0,    max: 100 },
      { key: 'bloom',          label: 'Bloom / Glow',      min: 0,    max: 100 },
      { key: 'heatDistortion', label: 'Heat Distortion',   min: 0,    max: 100 },
      { key: 'colorTemp',      label: 'Color Temperature', min: 0,    max: 100, hint: 'Cool → Warm' },
      { key: 'coreBrightness', label: 'Core Brightness',   min: 0,    max: 100 },
