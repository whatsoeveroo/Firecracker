...
export const EFFECTS = [
  ...
  },
  {
    ...
    params: [
      { key: 'sparkCount',  label: 'Spark Count',  min: 5,    max: 100 },
      { key: 'spreadAngle', label: 'Spread Angle', min: 5,    max: 360 },
      { key: 'length',      label: 'Velocity',     min: 10,   max: 140 },
      { key: 'brightness',  label: 'Exposure',     min: 10,   max: 100 },
      { key: 'decay',       label: 'Burnout',      min: 10,   max: 100, hint: 'fast ← → snappy' },
      { key: 'direction',   label: 'Direction',    min: -180, max: 180, hint: '−90 = up' },
      { key: 'flashSize',   label: 'Flash Core',   min: 0,    max: 100 },
      { key: 'gravity',     label: 'Gravity',      min: 0,    max: 100, advanced: true },
      { key: 'airDrag',     label: 'Air Drag',     min: 0,    max: 100, advanced: true },
      { key: 'chaos',       label: 'Scatter',      min: 0,    max: 100, advanced: true },
