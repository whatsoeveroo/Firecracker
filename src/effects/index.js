...
export const EFFECTS = [
  ...
  },
  {
    ...
    params: [
      ...
      { key: 'particleLife',     label: 'Particle Life',     min: 0,    max: 100 },
      { key: 'gravity',          label: 'Gravity',           min: 0,    max: 100 },
      { key: 'airDrag',          label: 'Air Drag',          min: 0,    max: 100 },
      { key: 'chaos',            label: 'Scatter / Noise',   min: 0,    max: 100 },
      { key: 'brightness',       label: 'Exposure',          min: 10,   max: 100 },
      { key: 'flashSize',        label: 'Flash Core',        min: 0,    max: 100 },
      { key: 'gasPlume',         label: 'Gas Plume',         min: 0,    max: 100 },
      { key: 'smokeAmount',      label: 'Smoke Amount',      min: 0,    max: 100 },
      { key: 'lensFlare',        label: 'Lens Flare',        min: 0,    max: 100 },
      { key: 'spillGlow',        label: 'Spill Glow',        min: 0,    max: 100 },
      { key: 'decay',            label: 'Burnout',           min: 0,    max: 100, hint: 'slow cool ← → fast cool' },
